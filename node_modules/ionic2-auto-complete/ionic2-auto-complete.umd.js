(function (global, factory) {
	...
	(factory((global['ionic2-auto-complete'] = {}),global._angular_core,global._angular_common,global._angular_forms,global.rxjs_util_noop,global.rxjs,global.ionicAngular));
}(this, (function (exports,_angular_core,_angular_common,_angular_forms,rxjs_util_noop,rxjs,ionicAngular) { 'use strict';
...
var AutoCompleteComponent = (function () {
    ...
    function AutoCompleteComponent() {
        ...
        this.onTouchedCallback = rxjs_util_noop.noop;
        this.onChangeCallback = rxjs_util_noop.noop;
        ...
        this.autoFocus = new _angular_core.EventEmitter();
        this.autoBlur = new _angular_core.EventEmitter();
        this.options = {};
        // set default options
    ...
    AutoCompleteComponent.prototype.writeValue = function (value) {
        if (value !== this.keyword) {
            ...
            if (value) {
                var labelAttribute = this.dataProvider.labelAttribute;
...
AutoCompleteComponent.propDecorators = {
    ...
    'autoFocus': [{ type: _angular_core.Output },],
    'autoBlur': [{ type: _angular_core.Output },],
    ...
    'documentClickHandler': [{ type: _angular_core.HostListener, args: ['document:click', ['$event'],] },],
};
